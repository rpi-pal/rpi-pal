...
## 0.22.3 (March 13, 2026)

- Add crate `regex` as a dependency - this is to facilitate the following:
- Implement the ability to use the PWM pin on newer models of the Pi 5, as
  it had changed between releases of that machine
- Improve error handling on GPIO interrupt code

## 0.22.2 (July 25, 2025)

- Move over to new repository
- Update of CI pipelines
